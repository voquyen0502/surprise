...
function Balloon(pic) {
    ...
    this.div.setAttribute("id", "balloon");
    if (pic == null) {
        // 气球半径大小，随机生成
        this.radius = randomRange(20, 80);
        // 气球颜色
        this.background = setBackground();
    } else {
        // 图片半径稍微大些
        this.radius = randomRange(40, 80);
        // 背景图片
...
var picArray = ["img/1.png", "img/2.jpg", "img/3.jpg", "img/4.jpg", "img/5.jpg", "img/6.jpg", "img/7.jpg", "img/8.jpg", "img/9.jpg", "img/10.jpg", "img/11.jpg", "img/12.jpg", "img/13.jpg"
];
